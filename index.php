...
<head>
  ...
  <title>ADVANCED CRUD IN PHP AND ES6</title>
...
<body>
  <div class="container">
    <div class="row mt-4">
      <div class="col-lg-12 d-flex justify-content-between align-items-center mb-3 mt-5">
        <div>
          <h4 class="text-dark">Users</h4>
        </div>
        <div>
          <button class="btn btn-success" type="button" data-toggle="modal" data-target="#addNewUserModal">Add New User</button>
        </div>
      </div>
    </div>
        ...
        <div class="modal-body">
          <form id="add-user-form" class="p-2" novalidate>
            ...
            <div class="mb-3">
              ...
              <div class="invalid-feedback">E-mail is required or is invalid!</div>
            </div>
